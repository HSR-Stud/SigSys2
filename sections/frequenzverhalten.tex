...
\subsection{Tipps Zuordnung Pol-Nullstellen-Diagramm $\Leftrightarrow$
Bode-Diagramm}
\begin{itemize}
  ...
  %\item $\frac{\prod{\text{Abstände NS zu spezifischem \omega}}}{\prod{x2}}$
  %\item $\frac{\prod(Abstände NS zu spezifischem \omega)}{\prod(Abstände PS zu
  %spezifischem \omega)}  \Longrightarrow $ Verstärkung
...
\subsection{Ortskurve (Nyquist-Diagramm) \formelbuch{193} \matlab{nyquist}}
\begin{tabular}{ll}
	\parbox{7cm}{
...
\subsection{Nichols-Diagramm \formelbuch{198} \matlab{nichols}}
\begin{tabular}{ll}
	\parbox{7cm}{
