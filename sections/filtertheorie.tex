...
\subsubsection{LC-Tiefpass bestimmen \formelbuch{389/420}}
...
\subsubsection{LC Tabellenindex}
\label{LC_tabellen}
\renewcommand{\arraystretch}{1.5}
...
\parbox{11.5cm}{
  ...
  \subsubsection{LC entnormieren\formelbuch{391}}
  \label{LC entnormieren}
  $\boxed{L = L_{FI} \cdot \dfrac{R_r}{\omega_r} \qquad
  C = C_{FI} \cdot \dfrac{R_r}{\omega_r}}$
	}
& \parbox{7cm}{
